...
interface VerticalPageSwiperProps {
...
export default function VerticalPageSwiper({
  componentArray,
  navLink,
  navText,
  navIcon,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.pageProgress}>
        {currentPage > 0 ? (
          ...
          >
            <Ionicons name="arrow-up" size={20} color={col[500]} />
          </TouchableOpacity>
        ) : (
        ...
        {currentPage < numPages - 1 ? (
          <TouchableOpacity
            ...
            style={[borders.borderXs900, boxShadows.md, styles.buttonBase]}
          >
            <Ionicons name="arrow-down" size={20} color={col[500]} />
          </TouchableOpacity>
        ) : navLink ? (
